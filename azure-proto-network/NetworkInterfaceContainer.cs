...
namespace azure_proto_network
{
    ...
    {
        internal NetworkInterfaceContainer(AzureResourceManagerClientContext context, ResourceGroupData resourceGroup, AzureResourceManagerClientOptions clientOptions) : base(context, resourceGroup) { }

        internal NetworkInterfaceContainer(AzureResourceManagerClientContext context, ResourceIdentifier id, AzureResourceManagerClientOptions clientOptions) : base(context, id) { }
        ...
        public override ArmResponse<NetworkInterface> Create(string name, NetworkInterfaceData resourceDetails, CancellationToken cancellationToken = default)
        {
            ...
            return new PhArmResponse<NetworkInterface, Azure.ResourceManager.Network.Models.NetworkInterface>(
                ...
                n => new NetworkInterface(ClientContext, new NetworkInterfaceData(n)));
        }
