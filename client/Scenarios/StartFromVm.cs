...
namespace client
{
    class StartFromVm : Scenario
    {
        public override void Execute()
        {
            ...
            var vm = client.GetResourceOperations<VirtualMachineOperations>(Context.SubscriptionId, Context.RgName, Context.VmName).GetModelIfNewer();
            ...
            var vm2 = rg.Vm(Context.VmName).GetModelIfNewer();
