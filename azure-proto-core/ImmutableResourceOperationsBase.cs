...
namespace azure_proto_core
{
    ...
    /// </summary>
    public abstract class ImmutableResourceOperationsBase<TResource, TOperations> : OperationsBase 
        where TResource:Resource 
        where TOperations: ImmutableResourceOperationsBase<TResource, TOperations>
    {
        public ImmutableResourceOperationsBase(ArmResourceOperations genericOperations) : this(genericOperations.ClientContext, genericOperations.Id) { }

        public ImmutableResourceOperationsBase(ArmClientContext context, ResourceIdentifier id) : this(context, new ArmResource(id)) { }

        public ImmutableResourceOperationsBase(ArmClientContext context, Resource resource) : base(context, resource)
        {
            Resource = resource;
        }
