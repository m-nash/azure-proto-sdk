...
namespace azure_proto_compute
{
    ...
    public static class ResourceGroupExtensions
    {
        ...
        {
            return new VirtualMachineContainer(resourceGroup.ClientContext, resourceGroup.Data);
        }
        ...
        {
            return new AvailabilitySetContainer(resourceGroup.ClientContext, resourceGroup.Data);
        }
